...
[Food Explorer](https://phenomenal-elf-ece942.netlify.app/)

Admin Access (user: admin@live.com / password: 123)
...
$ git clone git@github.com:Rrhapsod/FoodExplorer-backend.git
